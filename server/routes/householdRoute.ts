...
import { getHouseholdBasedOnParams, createHousehold,getPaginated, getHouseholds, getHouseholdDetail,getMembers ,deleteHousehold,updateHousehold} from "../controllers/HouseholdController";
...
router.post("/update", authMiddleware, updateHousehold);
